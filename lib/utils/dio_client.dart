...
import 'package:aplikasi_tugas/models/user_info.dart';
import 'package:aplikasi_tugas/utils/logging.dart';

class DioClient {
  final Dio _dio = Dio(
    BaseOptions(
      baseUrl: 'https://62c309b2876c4700f535280f.mockapi.io/todo_list',
      connectTimeout: 5000,
      receiveTimeout: 3000,
    ),
